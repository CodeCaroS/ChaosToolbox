...
test("rss parser extracts rss and atom item links", () => {
  ...
  `), [
    { title: "One & Two", url: "https://example.com/one", publishedAt: "Sun, 21 Jun 2026 10:00:00 GMT" },
    { title: "Atom Item", url: "https://example.com/atom", publishedAt: "2026-06-21T10:00:00Z" }
  ]);
});
